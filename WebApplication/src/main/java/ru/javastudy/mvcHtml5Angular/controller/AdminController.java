...
public class AdminController {
    ...
    public @ResponseBody String addCategory(HttpServletRequest req){
        try {
    ...
    public  @ResponseBody ModelAndView NewTest(HttpServletRequest req)throws java.io.IOException {
    ...
    public @ResponseBody String addTest(HttpServletRequest req){
        try {
            JSONObject json = new JSONObject();
    ...
    public @ResponseBody String AddTransactions(HttpServletRequest req){
        try {
            JSONObject json = new JSONObject();
    ...
    public @ResponseBody String DeleteQuestion(HttpServletRequest req){
        try {
            JSONObject json = new JSONObject();
    ...
    public @ResponseBody String AddQuestion(HttpServletRequest req){
        try {
            JSONObject json = new JSONObject();
